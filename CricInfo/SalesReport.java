...
public class SalesReport extends HttpServlet {
    ...
    private void displaySalesReport(HttpServletRequest request,
      ...
      utility.printHtml("LeftNavAdmin.html");
        ...
        pw.print("<div id='content008'>");
        pw.print("<div class='post008'>");
        pw.print("<center><h2 class='title'style= 'width: 1000px;'>");
        ...
        pw.print("<div id='content009'>");
        pw.print("<div class='post009'>");
        pw.print("<center><h2 class='title'>");
        ...
        pw.print("<div id='content010'>");
        pw.print("<div class='post010'>");
        pw.print("<center><h2 class='title'>");

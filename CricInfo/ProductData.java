...
response.setContentType("text/html");
 ...
 pw.println("<body>");
		...
		pw.print("<div id='content'><div class='post012'><h2 class='title meta'>");
		pw.print("<center><h2 style='font-size: 24px;' 'font-color:black;'>SEARCHED PRODUCT</h2></center>");
		...
		pw.print("<td><div id='shop_item'>");
			...
			pw.print("<li id='item'><img src='images/pro/"+data.getImage()+"' alt='' /></li>");

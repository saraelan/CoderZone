    ...
    protected void review(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            //  pw.print("</td></tr>");
              ...
              pw.print("<tr>");
              pw.print("<td><b> User gender: </b></td>");
              pw.print("<td>");
              ...
              pw.print("<tr>");
              pw.print("<td><b>User Occupation:</b> </td>");
              pw.print("<td> <input type='text' name='userOccupation'></td>");
              pw.print("</tr>");

              pw.print("<tr><td><b> Retailer Zip: </b></td>");
              pw.print("<td> <input type='text' name='retailerpin'></td>");
              pw.print("</tr>");

              pw.print("<tr><td><b> Retailer City: </b></td>");
              pw.print("<td> <input type='text' name='retailerCity'></td>");
              pw.print("</tr></table>");

              pw.print("<table><tr></tr><tr></tr><tr><td><b> Review Rating: </b> </td>");
              pw.print("<td>");
              ...
              pw.print("<tr>");
              pw.print("<td><b> Review Date: <b></td>");
              pw.print("<td> <input type='date' name='reviewdate'></td>");
              pw.print("</td></tr>");
              pw.print("</tr>");

              pw.print("<tr>");
              pw.print("<td><b> Review Text: </b> </td>");
              pw.print("<td><textarea name='reviewtext' rows='4' cols='50'> </textarea></td></tr>");
              pw.print("<tr><td colspan='2'><button class='btn btn-primary btn-sm' input type='submit' class='btnbuy' name='SubmitReview' value='SubmitReview'>Submit Review</button></td></tr></table>");

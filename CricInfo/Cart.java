...
/* displayCart Function shows the products that users has bought, these products will be displayed with Total Amount.*/
	...
	protected void displayCart(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<div id='content11'><div class='post011'><h2 class='title meta'>");
		pw.print("<center><h2 style='font-size: 24px;' 'font-color:black'>Cart("+utility.CartCount()+")</h2></center>");
	...
	//	pw.print("<form name ='Cart' action='CheckOut' method='post'>");
		if(utility.CartCount()>0)
		{
			...
			for (OrderItem oi : utility.getCustomerOrders())
			{
				...
				pw.print("<td><button class ='btn btn-danger' type='submit' name='RemoveCart' value='Remove' class='btnbuy'>Remove</button></td>" );
			...
			pw.print("<tr><td></td><td></td><td><button class='btn btn-primary btn-sm' type='submit' name='CheckOut' value='CheckOut' class='b	tnbuy'>CheckOut</button></td>");
			pw.print("</table></form>");

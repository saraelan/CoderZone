...
public class CheckOut extends HttpServlet {
	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pw.print("<div id='content'><div class='post006'><h2 class='title meta'>");
		pw.print("<center><h2 style='font-size: 24px;' 'font-color:black;'>ORDERS</h2></center>");
  	...
  	pw.print("Credit/accountNo : </td>");
		...
		pw.print("<button class='btn btn-primary btn-sm' type='submit' name='submit' class='btnbuy'>Submit</button>");

            ...
            if (hm == null) {
                ...
                if (!hm.containsKey(productName)) {
                    ...
                    for (Review r : hm.get(productName)) {
                        ...
                        pw.print("<tr>");
                        pw.print("<td><b> User Name: </b></td>");
                        userName = r.getUserName();
                        pw.print("<td>" + userName + "</td>");
                        pw.print("</tr>");

                        pw.print("<tr>");
                        pw.print("<td><b> UserAge:</b> </td>");
                        ...
                        pw.print("<tr>");
                        pw.print("<td><b> Retailer City: </b></td>");
                        ...
                        pw.print("<tr>");
                        pw.print("<td><b> Retailer Pin:</b> </td>");
                        pin = r.getRetailerPin();
                        pw.print("<td>" + pin + "</td>");
                        pw.print("</tr>");

                        pw.println("<tr>");
                        pw.println("<td><b> Review Rating:</b> </td>");
